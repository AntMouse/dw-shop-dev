...
public class AOrderController {
    ...
    private final com.example.DWShopProject.order.service.AOrderService AOrderService;

    @Autowired
    public AOrderController(com.example.DWShopProject.order.service.AOrderService AOrderService) {
    ...
    public ResponseEntity<AOrderDto> createOrder(@RequestBody AOrderDto orderDto) {
        AOrderDto createdOrder = AOrderService.createOrder(orderDto);
